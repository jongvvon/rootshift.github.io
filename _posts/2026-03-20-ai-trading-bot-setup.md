...
new Chart(document.getElementById('equityChart'), {
  type: 'line',
  data: {
    labels: ['03-20', '03-23', '03-24', '03-25', '03-26', '03-27', '03-30', '03-31', '04-01', '04-02', '04-03', '04-06', '04-07', '04-08', '04-09'],
    datasets: [{
      label: '총 자산 ($)',
      data: [99766, 99299, 99366, 99290, 99100, 105182, 107735, 100160, 97222, 104058, 104192, 103289, 102802, 97028, 95894],
      borderColor: '#4CAF50',
